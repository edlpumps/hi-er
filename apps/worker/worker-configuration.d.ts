/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 238dde784000dee5e4a2ec51e563b011)
...
declare namespace Cloudflare {
	...
	interface Env {
		PARTICIPANT_LABELS_BUCKET: R2Bucket;
		PARTICIPANT_LABEL_JOB: DurableObjectNamespace<import("./src/index").ParticipantLabelJob>;
		PATICIPANT_LABELS_WORKFLOW: Workflow<Parameters<import("./src/index").ParticipantLabelWorkflow['run']>[0]['payload']>;
	}
}
